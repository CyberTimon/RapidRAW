...
export const DEFAULT_PANEL_DEFAULT_REGIONS: Record<Panel, PanelRegion> = {
  ...
  [Panel.ColorCurves]: 'rightTop',
  [Panel.Details]: 'rightTop',
  [Panel.Effects]: 'rightTop',
  [Panel.Crop]: 'rightTop',
...
export const useUIStore = create<UIState>((set, get) => ({
  ...
  slideDirection: 1,
  collapsibleSectionsState: { basic: true, color: true, curves: true, details: true, effects: true },
