...
export default function NegativeConversionModal({ onClose, onSave }: NegativeConversionModalProps) {
  const { negativeModalState } = useAppState();
  const { isOpen, targetPath: selectedImagePath } = negativeModalState;
