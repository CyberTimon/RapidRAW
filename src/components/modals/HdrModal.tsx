  ...
  const renderContent = () => {
    if (error) {
      return (
        <>
          ...
          <h3 className="text-lg font-semibold text-text-primary mb-2 text-center">{t('modals:hdr.failed')}</h3>
        ...
        <>
          {savedPath && (
            <>
              ...
              <h3 className="text-lg font-semibold text-text-primary mb-4 text-center">{t('modals:hdr.saved')}</h3>
            </>
          )}
          <div className="w-full bg-bg-primary rounded-md overflow-hidden border border-surface">
            <img src={finalImageBase64} alt={t('modals:hdr.merging')} className="w-full h-full object-contain" />
          </div>
        </>
      );
    }
    ...
    return (
      <>
        ...
        <h3 className="text-lg font-semibold text-text-primary mb-2 text-center">{t('modals:hdr.merging')}</h3>
      ...
      return (
        <>
          ...
          <Button onClick={handleSave} disabled={isSaving}>
            ...
            {isSaving ? t('common:actions.saving') : t('modals:hdr.save')}
          </Button>
        </>
      );
    }
