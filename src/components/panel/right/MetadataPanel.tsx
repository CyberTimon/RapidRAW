...
export default function MetadataPanel({ tags, onRate, onSetColorLabel, onTagsChanged }: MetaDataPanelProps) {
  const { selectedImage, appSettings, adjustments } = useAppState();
  if (!selectedImage) return <></>;
  const rating = adjustments.rating;
