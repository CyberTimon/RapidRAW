...
- To import a library tree, right-click a folder and choose **Import Matching XMP Sidecars (Recursive)**. Images and sidecars are matched by filename within each folder, including nested folders.
