...
print("=== EXIF AUDIT OF CR2 SOURCE FILES (4746 to 4751) ===")
for i in range(4744, 4754):
...
print("\n=== PIXEL & ARTIFACT AUDIT OF IMG_4746_Pano_UltraHDR.jpg ===")
pano_path = r'D:\neapdirbti\IMG_4746_Pano_UltraHDR.jpg'
if os.path.exists(pano_path):
    ...
    # Check bottom half (river & embankment)
    bottom_half = arr[h//2:, :, :]
    print(f"Bottom 50% mean RGB: {bottom_half.mean(axis=(0,1))}")
