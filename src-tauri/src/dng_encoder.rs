...
pub fn encode_linear_dng(image: &Rgb32FImage, metadata: Option<&DngExportMetadata>) -> Result<Vec<u8>, String> {
    ...
    // Converts Camera Linear RGB to CIE XYZ (D65)
    // [ 3.2404542, -1.5371385, -0.4985314 ]^-1 = [0.4124564, 0.3575761, 0.1804375, 0.2126729, 0.7151522, 0.0721750, 0.0193339, 0.1191920, 0.9503041]
    ...
    let be_val = meta.baseline_exposure.unwrap_or(0.0);
